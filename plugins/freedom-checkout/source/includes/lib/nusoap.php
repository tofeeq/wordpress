	...
	function invoke_method() {
		...
		if ($class == '') {
			if (!function_exists($this->methodname)) {
				...
				$this->fault('soap:Client',"method '$this->methodname'('$orig_methodname') not defined in service('$try_class' '$delim')");
				return;
			}
		} else {
			...
			if (!in_array($method_to_compare, get_class_methods($class))) {
				...
				$this->result = 'fault: method not found';
				$this->fault('soap:Client',"method '$this->methodname'/'$method_to_compare'('$orig_methodname') not defined in service/'$class'('$try_class' '$delim')");
				return;
			}
		}
